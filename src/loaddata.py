    ...
    if path.exists(filepath):
        ...
        for entry in data:
            ...
            if armtype in HELM_NAMES:
                helms.append((name, slots1, slots2, slots3, skills[0][0],
                              skills[0][1], skills[1][0], skills[1][1],
                              skills[2][0], skills[2][1], skills[3][0], skills[3][1]))
            elif armtype in CHEST_NAMES:
                chests.append((name, slots1, slots2, slots3, skills[0][0],
                              skills[0][1], skills[1][0], skills[1][1],
                              skills[2][0], skills[2][1], skills[3][0], skills[3][1]))
            elif armtype in VAMBRACE_NAMES:
                vambraces.append((name, slots1, slots2, slots3, skills[0][0],
                               skills[0][1], skills[1][0], skills[1][1],
                               skills[2][0], skills[2][1], skills[3][0], skills[3][1]))
            elif armtype in FAULD_NAMES:
                faulds.append((name, slots1, slots2, slots3, skills[0][0],
                               skills[0][1], skills[1][0], skills[1][1],
                               skills[2][0], skills[2][1], skills[3][0], skills[3][1]))
            elif armtype in GREAVE_NAMES:
                greaves.append((name, slots1, slots2, slots3, skills[0][0],
                               skills[0][1], skills[1][0], skills[1][1],
                               skills[2][0], skills[2][1], skills[3][0], skills[3][1]))
            else:
